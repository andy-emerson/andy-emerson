...
* Both [love.wasm](https://github.com/andy-emerson/love.wasm) and [lua.wasm](https://github.com/andy-emerson/lua.wasm) are starting to be appreciated by those communities. [blas.wasm](https://github.com/andy-emerson/blas.wasm) provides the WebAssembly foundation for future numeric work.
