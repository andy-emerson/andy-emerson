...
2. 1. literate programming (inspired by Knuth, but adopted to the AI era), and
   2. 3. structured collaboration with AI agents (see the [Working Agreement](https://github.com/andy-emerson/working-agreement)).
